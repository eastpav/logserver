...
gboolean semcheck(tfilter_t *dfw, stnode_t *stNode);
...
gboolean checkRelation(tfilter_t *dfw, test_op_t stOp, stnode_t *stNode, stnode_t *stArg1, stnode_t *stArg2)
{
    gboolean ret = FALSE;
...
gboolean checkTest(tfilter_t *dfw, stnode_t *stNode)
{
    test_op_t stOp;
...
gboolean dfw_semcheck(tfilter_t *dfw)
{
    return semcheck(dfw, dfw->stRoot);
}
